...
<p class="text-center setup-actions">
    <a href="${request.getContextPath}?setup=wizard&step=${SetupHelper.getWizardNextStep(param.step)}" 
    ...
    <button href="${request.getContextPath}?setup=wizard&step=${SetupHelper.getWizardNextStep(param.step)}" 
            class="btn btn-md btn-primary save-configuration">
        <b><span class="fa fa-floppy-o"></span> Save Configuration<b>
    </button>
    <a href="${request.getContextPath}?setup=wizard&step=${SetupHelper.getWizardPreviousStep(param.step)}" 
